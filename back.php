...
<body>
	...
	<div id="all">
		<div id="title">
			<?= date("m 月 d 日 l"); ?> | 今日瀏覽: <?= $Visit->find(['date' => date("Y-m-d")])['visit']; ?> | 累積瀏覽: <?= $Visit->math('sum', 'visit'); ?> <span style="float: right;"><a href="./index.php">回首頁</a></span></div>
		<div id="title2">
				...
				<div>
					...
					if(isset($_SESSION['user'])){
						if($_SESSION['user']=="admin"){
							echo "歡迎，".$_SESSION['user']."<br><a href='./back.php'><button>管理</button></a> | <button onclick='logoutFun()'>登出</button>";
						}else{
							echo "歡迎，".$_SESSION['user']."<button onclick='logoutFun()'>登出</button>";
						}
					}else{
